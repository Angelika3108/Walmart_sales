...
# Connect to MySQL
db_engine = create_engine("mysql+pymysql://root:Coldplay0202@localhost/walmart")
...
queries = {
    ...
    "Avg_Weekly_Sales": "SELECT Store, ROUND(AVG(Weekly_Sales), 2) AS Avg_Weekly_Sales FROM walmart_sales GROUP BY Store ORDER BY Avg_Weekly_Sales DESC;",
